...
import Taho from '../../north/north-taho/north-taho.schema.jsx'

const NorthSchemas = { OIConnect, AmazonS3, Console, InfluxDB, OIAnalytics, TimescaleDB, MongoDB, MQTT, WATSYConnect, CsvToHttp, FileWriter, Taho }
